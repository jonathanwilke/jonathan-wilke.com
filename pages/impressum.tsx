...
export default function Impressum() {
  return (
    <div>
      ...
      <h2 className="mb-4">Angaben gem&auml;&szlig; &sect; 5 TMG</h2>
      <p className="mb-6">
        Jonathan Wilke
        <br />
        Web-Entwickler
      ...
      <p className="mb-6">
        ...
        <br />
        E-Mail: kontakt@jonathan-wilke.de
      </p>
      <h2 className="mb-6">
      ...
      <h3 className="mb-6">Haftung f&uuml;r Inhalte</h3>{' '}
      <p className="mb-6">
      ...
      <h3 className="mb-6">Haftung f&uuml;r Links</h3>{' '}
      <p className="mb-6">
      ...
      <h3 className="mb-6">Urheberrecht</h3>{' '}
      <p className="mb-6">
