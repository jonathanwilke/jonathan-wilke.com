  ...
  return (
    <div>
      ...
      <p>
        Jonathan Wilke
        <br />
        Auf dem Placken 5<br />
        59071 Hamm
      </p>
      <p>
        <strong>E-Mail-Adresse</strong>: kontakt@jonathan-wilke.de
      </p>
      <p>
        <strong>Impressum</strong>:
        <a
          href="https://jonathan-wilke.com/impressum"
          target="_blank"
          rel="noopener"
        >
          https://jonathan-wilke.com/impressum
        </a>
      </p>
      ...
      <ul>
        ...
        <li>
          ...
          IP-Masking ein Mittel zur Pseudonymisierung von
        ...
        <li>
          ...
          Nutzern), die in einem sogenannten Profil gespeichert werden. Zu
          diesen Zwecken werden im Regelfall Cookies eingesetzt.
        </li>
        <li>
